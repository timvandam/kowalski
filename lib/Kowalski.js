...
class Kowalski extends Readable {
  ...
  constructor ({
    ...
    informationToCollect.forEach((Information, index) => {
      ...
      if (Information.prototype._getInformation === Kowalski.Information.prototype._getInformation) throw new InvalidArgumentException(`informationToCollect[${index}] must have getInformation defined!`)
    ...
    this.pipe(this.storage = new Storage(this.informationTypes))
   ...
   * @todo allow information collection for non-requests
   */
